...
Siehe [docs/UI.md](./docs/UI.md) für die vollständige UI-Dokumentation mit:

- Spielerkachel-Layouts
- Reifegrad-basierte UI (Grad 1-3)
- Interaktions-Matrix
- Setup-Screen & Spiel-Ende-Screen
- Barrierefreiheit
